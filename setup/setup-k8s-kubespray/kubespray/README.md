...
declare -a IPS=(192.168.56.6 192.168.56.2 192.168.56.3 192.168.56.4 192.168.56.5)

CONFIG_FILE=inventory/k8s-dev/hosts.yaml python3 contrib/inventory_builder/inventory.py ${IPS[@]}
...
ansible-playbook -i inventory/k8s-dev/hosts.yaml  -u root --become --become-user=root cluster.yml
```
